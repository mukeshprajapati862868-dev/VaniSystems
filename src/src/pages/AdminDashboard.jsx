...
import EventManagement from "../components/home/EventsPhotos";
...
const AdminDashboard = () => {
  ...
  const [isGalleryEditing, setIsGalleryEditing] =
    useState(false);
  ...
  const addProduct = async (e) => {
    ...
    try {
      ...
      const productData = {
        ...
        discount:
          parseFloat(productForm.discount),

        gst:
          parseFloat(productForm.gst) || 18,

        shippingCharge:
          parseFloat(
            productForm.shippingCharge
          ) || 0,
    ...
    return (
      ...
      <div className="container py-5 mt-5 text-center">
        ...
        <p className="text-muted mb-4">
          You need to be logged in with an admin
    ...
    >
      ...
      <div className="container-fluid">
        ...
        <div className="row">
          ...
          <div
            className={`col-12 col-lg-3 col-xl-2 p-0 ${sidebarOpen
                ? "d-block"
                : "d-none d-lg-block"
              }`}
          >
            ...
            >
              ...
              <div className="d-grid gap-2">
                ...
                <button
                  className={`btn text-start ${activeSection === "events"
                      ? "btn-warning"
                      : "btn-outline-light"
                    }`}
                  onClick={() => {
                              ...
                              >
                                ...
                                <td>
                                  ...
                                  <div className="d-flex gap-2">
                                    ...
                                    <button
                                      className={`btn btn-sm ${employee.status ===
                                          "Active"
                                          ? "btn-danger"
                                          : "btn-success"
                                        }`}
        ...
        {!selectedCandidate && (
          ...
          candidates.length === 0 ? (
            ...
            <div className="text-center py-5">
              ...
              <h5 className="mt-3">
                No Candidate Registration Found
              </h5>

              <p className="text-muted">
                Online Registration से candidate
                add होने पर यहां दिखेगा।
              </p>
                    ...
                    (candidate, index) => (
                      ...
                      >
                        ...
                        <td>
                          ...
                          <span
                            className={`badge ${candidate.paymentStatus ===
                                "Paid"
                                ? "bg-success"
                                : "bg-danger"
                              }`}
                        ...
                        <td>
                          ...
                          <div className="d-flex gap-2">
                            ...
                            <button
                              className={`btn btn-sm ${candidate.paymentStatus ===
                                  "Paid"
                                  ? "btn-warning"
                                  : "btn-success"
                                }`}
